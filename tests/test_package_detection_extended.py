...
async def test_ubus_package_detection_extended():
    ...
    with patch.object(client, "_list_objects", new_callable=AsyncMock) as mock_list, \
         patch.object(client, "_call", new_callable=AsyncMock) as mock_call, \
         patch.object(client, "get_installed_packages", new_callable=AsyncMock) as mock_pkg:
